...
QT_MOC_LITERAL(1, 14, 14), // "si_setRuleOrga"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 25) // "on_RuleOrganizer_accepted"

    },
    "RuleOrganizer\0si_setRuleOrga\0\0"
    "on_RuleOrganizer_accepted"
};
...
void RuleOrganizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->si_setRuleOrga((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_RuleOrganizer_accepted(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RuleOrganizer::si_setRuleOrga)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RuleOrganizer::si_setRuleOrga(int _t1)
{
